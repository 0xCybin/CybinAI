...
export default function EditArticlePage() {
  ...
  const fetchArticle = useCallback(async () => {
    try {
      const res = await fetch(`${API_URL}/api/v1/knowledge-base/articles/${articleId}`, {
    ...
    <div className="min-h-screen bg-[#1A1915] p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-neutral-100">Edit Article</h1>
            <p className="text-neutral-400 mt-1">Update your knowledge base article</p>
          </div>
        </div>
